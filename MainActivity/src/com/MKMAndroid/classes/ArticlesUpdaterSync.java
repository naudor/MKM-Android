 ...
 */
public class ArticlesUpdaterSync extends AsyncTask<String, Integer, ArrayList<Article>> {
    ...
    public ArticlesUpdaterSync(ProgressDialog dialog)
    {
        this.dialog = dialog;
    }
    ...
    protected void onPostExecute(ArrayList<Article> newArticles)
    {
