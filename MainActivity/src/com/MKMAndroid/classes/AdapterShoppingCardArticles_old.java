...
public class AdapterShoppingCardArticles_old extends BaseAdapter {
    ...
    public AdapterShoppingCardArticles_old(Activity activity, ArrayList<Article> items, ArrayList<Product> products) {
        this.items = items;
        this.products = products;
        mInflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public AdapterShoppingCardArticles_old(LayoutInflater inflater, ArrayList<Article> items) {
        this.items = items;
        mInflater = inflater;
    }
