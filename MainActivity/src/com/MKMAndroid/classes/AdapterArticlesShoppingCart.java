...
public class AdapterArticlesShoppingCart extends BaseAdapter {
    ...
    public AdapterArticlesShoppingCart(Activity activity, ArrayList<Article> items, ArrayList<Product> products) {
        this.items = items;
        this.products = products;
        mInflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public AdapterArticlesShoppingCart(LayoutInflater inflater, ArrayList<Article> items, ArrayList<Product> products) {
        this.items = items;
        this.products = products;
        mInflater = inflater;
    }
